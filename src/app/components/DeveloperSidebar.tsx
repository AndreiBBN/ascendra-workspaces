...
const navigation = [
  { name: 'My Machines', href: '/developer', icon: Monitor },
];
...
export function DeveloperSidebar() {
  ...
  return (
    <div className="w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 flex flex-col flex-shrink-0">
      ...
      <nav className="flex-1 p-4 space-y-0.5" aria-label="Developer navigation">
        {navigation.map((item) => {
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700 space-y-2">
        <p className="text-xs text-gray-400 dark:text-gray-500">Developer Console</p>
        <Link
          to="/dashboard"
